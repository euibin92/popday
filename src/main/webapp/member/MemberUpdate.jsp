		...
		<div class="member_wrap">
			...
			<form action="memberUpdate.do" method="post" name="frm">
				<div class="member_box">
					...
					<div class="box_item">
						<input type="password" name="pwd" class="input" placeholder="새 비밀번호" size="20">
					</div>
					<div class="box_item">
						<input type="password" name="pwd_check" class="input" placeholder="새 비밀번호 확인" size="20">
					</div>
					<div class="box_item">
						<input type="text" name="email" class="input" size="20" value="${mdto.email}" style="color: gray">
					</div>
					<div class="box_item">
						<input type="text" name="phone" class="input" size="20" value="${mdto.phone}" style="color: gray">
					</div>
					<div class="box_item">
